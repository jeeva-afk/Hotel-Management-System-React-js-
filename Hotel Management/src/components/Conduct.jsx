...
<form>
    <div class="form">
        <div class="form-txt">
            ...
            attention.</span>
            <h3>USA</h3>
            <p>195 E Parker Square Dr, Parker, CO 801<br/>+43 765 353 876</p>
            <h3>India</h3>
            <p>HW95+C9C, Mhada Colony, Viman Nagar, Kolkata, East Bengal<br/>411014</p>
        </div>
